...
8. **Stage your changes — commit only when running standalone.** Stage the specific files you changed (not `git add -A`). Then, depending on how you were invoked:
