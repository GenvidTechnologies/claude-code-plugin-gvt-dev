...
`code-reviewer.md:103` ("the pre-committed `## Acceptance Criteria` checklist") read literally. The body is rebuilt from three parts —
...
1. **Tolerate-and-preserve the matched spelling**, writing the section back
   ...
   `plugin/agents/validator.md:42` ("read its `## Acceptance Criteria` section") and `plugin/agents/code-reviewer.md:103` ("the pre-committed `## Acceptance Criteria` checklist"),
